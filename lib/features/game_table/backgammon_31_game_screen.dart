...
import '../../../core/game_engine/games/backgammon_31/backgammon31_engine.dart';
          ...
          child: Column(
            children: [
              ...
              Expanded(
                child: Row(
                  children: [
                    // Left Panel: Target 31 circle & status message
                    Expanded(
                      flex: 4,
                      child: Column(
                    ...
                    // Right Panel: Player vs Bot cards, Dice, and Buttons
                    Expanded(
                      flex: 6,
                      child: Padding(
